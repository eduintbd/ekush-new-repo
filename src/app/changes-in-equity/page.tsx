        ...
        <table className="min-w-full divide-y divide-zinc-200 text-sm dark:divide-zinc-800">
          <thead className="bg-zinc-50 text-xs font-semibold uppercase tracking-wider text-zinc-500 dark:bg-zinc-950">
            <tr>
              ...
              <th className="px-4 py-3 text-left">Paid-up Capital</th>
              <th className="px-4 py-3 text-left">Fair Value Reserve</th>
              <th className="px-4 py-3 text-left">Retained Earnings</th>
...
function Row({ row }: { row: ChangesInEquityRow }) {
  ...
  return (
    <tr className={cls}>
      ...
      <td className="px-4 py-2 text-left tabular-nums">{fmt(row.paidUpCapital)}</td>
      <td className="px-4 py-2 text-left tabular-nums">{fmt(row.fairValueReserve)}</td>
      <td className="px-4 py-2 text-left tabular-nums">{fmt(row.retainedEarnings)}</td>
      <td className="px-4 py-2 text-left tabular-nums">{fmt(row.total)}</td>
    </tr>
  );
}

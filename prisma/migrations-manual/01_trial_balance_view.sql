-- Per spec §5.11. Apply manually via psql after `prisma db push`:
--   psql $DIRECT_URL -f prisma/migrations-manual/01_trial_balance_view.sql
--
...
CREATE OR REPLACE VIEW xsystem.trial_balance AS
SELECT
...
FROM xsystem.chart_of_accounts coa
CROSS JOIN xsystem.fiscal_years fy
LEFT JOIN xsystem.journals j
